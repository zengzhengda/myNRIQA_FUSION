function [feature]=fetchFeature(disimg,cnt_img_level)
...
%     entropy_fea=entropy(disimg_gray);
    %% 特征向量
    % 基本特征6 MN颜色特征10项 NSS特征5   sharpness特征7项  显著性特征2 
    feature=[feature fea_MN feature_base feature_nss sharpness_fea  feature_saliency];
